...
const ar: Translations = {
  ...
  forgotPasswordScreen: {
    ...
    successDescription: "انقر على الرابط في البريد الإلكتروني لإعادة تعيين كلمة المرور. إذا لم تره، تحقق من مجلد الرسائل غير المرغوب فيها.",
  },
  emailVerificationScreen: {
    title: "تحقق من بريدك الإلكتروني",
    subtitle: "لقد أرسلنا بريد تأكيد إلى {{email}}",
    checkInbox: "تحقق من صندوق الوارد",
    description: "لقد أرسلنا رابط تأكيد إلى {{email}}. انقر على الرابط في البريد الإلكتروني للتحقق من حسابك.",
  ...
  onboardingScreen: {
    ...
    welcomeSubtitle: "نحن متحمسون لمساعدتك في بناء تطبيقك الرائع التالي. لنقم بإعدادك في ثوانٍ قليلة.",
    letsGo: "هيا بنا",
    goalsTitle: "هدفك",
